...
export default function Home() {
  ...
  return (
    <div>
      <div>
        <div className='absolute sm:scale-[130%] md:scale-[200%] z-10 left-0 mx-auto right-0 w-fit top-[200px] sm:top-[260px] md:top-[300px]'>
        ...
        <div className='w-fit'>
          <Image src={windowsvg} height={435} alt="" className='mask left-10 right-0 mx-auto top-[120px] sm:scale-125 md:scale-[200%] sm:top-[175px] md:top-[340px]'/>
          <Image src={glass} height={435} alt="" className=' baseimg mx-auto left-[1rem] right-0 top-[120px] sm:scale-125 md:scale-[200%] sm:top-[175px] md:top-[340px]'/>
        </div>
      </div>
      ...
      <div className='flex my-10 '>
        ...
        className='max-w-[45%] h-fit my-auto inline-block rounded-l-2xl -z-10'
        />
      </div>
